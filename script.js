...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // URL DO WEBHOOK N8N
    const WEBHOOK_URL = 'https://n8n.srv1352561.hstgr.cloud/webhook/atestados';
   ...
   const emailsEscolas = {
    ...
    "Conselho Municipal de Educação" :	"conselhomeducacao@semecabofrio.rj.gov.br",
    "Conselho Municipal Fundeb" : "conselhomfundeb@semecabofrio.rj.gov.br",
    "Conselho de Alimentação Escolar" : "cae@semecabofrio.rj.gov.br",
